        ...
        for (Character character : frequencies) {
            ...
            for (int i = 0; i < node_locations.size(); i++) {
                for (int j = 0; j < node_locations.size(); j++) {
                    if (i != j) {
                        // Find the two antinodes for the two nodes.
                        ...
                        int antinode_1_x = node_1_x - (node_2_x - node_1_x);
                        int antinode_1_y = node_1_y - (node_2_y - node_1_y);
                        int antinode_2_x = node_2_x - (node_1_x - node_2_x);
                        int antinode_2_y = node_2_y - (node_1_y - node_2_y);
